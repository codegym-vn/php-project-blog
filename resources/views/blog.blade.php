...
@section('content')
    ...
    <nav class="navbar navbar-expand-lg bg-secondary fixed-top text-uppercase" id="mainNav">
        <div class="container">
            <a class="navbar-brand js-scroll-trigger" href="{{route(BLOG)}}">BLOG FOR ME</a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item mx-0 mx-lg-1">
                        <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#">Category</a>
                    </li>
                    <li class="nav-item mx-0 mx-lg-1">
                    ...
                    @else
                        <li class="nav-item dropdown nav-item mx-0 mx-lg-1">
                            <a class="nav-link dropdown-toggle nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#" role="button"
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container">
            ...
            <h1 class="text-uppercase mb-0">Welcome To Blog </h1>
            <hr class="star-light">
    ...
    <section class="portfolio" id="portfolio">
        <div class="container">
            <h2 class="text-center text-uppercase text-secondary mb-0">Category</h2>
    ...
    <footer class="footer text-center">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <h4 class="text-uppercase mb-4">About For Me</h4>
                    <p class="lead mb-0">
